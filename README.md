...
**Gnome packages**
```
pacman -S gnome gnome-firmware papers showtime mission-center ghostty && pacman -Rns evince gnome-connections gnome-maps gnome-music gnome-user-docs totem yelp
```
**Kde packages**
```
